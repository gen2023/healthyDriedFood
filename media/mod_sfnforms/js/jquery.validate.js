...
$.extend( $.validator, {
	...
	messages: {
		required: Joomla.JText._('MOD_SFNFORMS_REQUIRED'),
		email: Joomla.JText._('MOD_SFNFORMS_ERROR_EMAIL'),
		maxlength: Joomla.JText._('MOD_SFNFORMS_ERROR_MINLENGTH'),
		// phoneUA: Joomla.JText._('MOD_SFNFORMS_ERROR_NUMBER'),
		// minlength: Joomla.JText._('MOD_SFNFORMS_ERROR_MAXLENGTH'),
		// number: Joomla.JText._('MOD_SFNFORMS_ERROR_NUMBER'),
