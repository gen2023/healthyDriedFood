...
<div class="nevigen-onestepcheckout_shipping_block">
	...
	<div data-nevigen-onestepcheckout="shipping">
		<?php foreach ($this->shipping_methods as $shipping):
			...
			<div class="shipping_wrapper <?php if ($checked) echo 'active' ?>"
				 data-nevigen-onestepcheckout-shipping="<?php echo $shipping->sh_pr_method_id; ?>">
				<div class="d-flex align-content-center">
					...
					<div class="w-100 ms-2">
						<label for="shipping_method_<?php echo $shipping->sh_pr_method_id ?>" class="d-block">
							<div class="d-flex align-content-center justify-content-between">
								<div class="d-flex align-content-center">
									<?php if ($shipping->image): ?>
										<div class="shipping_image">
											<img src="<?php echo $shipping->image ?>"
								...
								<div>
									...
									<?php else: ?>
										<span class="btn btn-sm btn-success nvg_shipping_cost">
											<?php echo Text::_('PLG_SYSTEM_NEVIGEN_JSHOP_ONESTEPCHECKOUT_SHIPPING_FREE'); ?>
										</span>
									<?php endif; ?>
								</div>
							</div>
