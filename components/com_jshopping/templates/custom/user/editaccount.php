        ...
        <form action="<?php print $this->action ?>" method="post" name="loginForm" class="form-validate form-horizontal" enctype="multipart/form-data">
          ...
          <div class="jshop_register">
            ...
            <?php if ($config_fields['title']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="title">
                    <?php print Text::_('JSHOP_REG_TITLE') ?>   <?php if ($config_fields['title']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
            ...
            <?php if ($config_fields['f_name']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="f_name">
                    <?php print Text::_('JSHOP_F_NAME') ?>   <?php if ($config_fields['f_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="f_name" id="f_name" value="<?php print $this->user->f_name ?>"
                    class="input form-control <?php if ($config_fields['f_name']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['l_name']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="l_name">
                    <?php print Text::_('JSHOP_L_NAME') ?>   <?php if ($config_fields['l_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="l_name" id="l_name" value="<?php print $this->user->l_name ?>"
                    class="input form-control <?php if ($config_fields['l_name']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['m_name']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="m_name">
                    <?php print Text::_('JSHOP_M_NAME') ?>   <?php if ($config_fields['m_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="m_name" id="m_name" value="<?php print $this->user->m_name ?>"
                    class="input form-control <?php if ($config_fields['m_name']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="firma_name">
                    <?php print Text::_('JSHOP_FIRMA_NAME') ?>   <?php if ($config_fields['firma_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="firma_name" id="firma_name" value="<?php print $this->user->firma_name ?>"
                    class="input form-control <?php if ($config_fields['firma_name']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="client_type">
                    <?php print Text::_('JSHOP_CLIENT_TYPE') ?>   <?php if ($config_fields['client_type']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
              ...
              <div class="control-group" id='tr_field_firma_code' <?php if ($config_fields['client_type']['display']): ?>style="display:none;" <?php endif; ?>>
                <div class="control-label name">
                  <label for="firma_code">
                    <?php print Text::_('JSHOP_FIRMA_CODE') ?>   <?php if ($config_fields['firma_code']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
              ...
              <div class="control-group" id='tr_field_tax_number' <?php if ($config_fields['client_type']['display']): ?>style="display:none;" <?php endif; ?>>
                <div class="control-label name">
                  <label for="tax_number">
                    <?php print Text::_('JSHOP_VAT_NUMBER') ?>   <?php if ($config_fields['tax_number']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
            ...
            <?php if ($config_fields['email']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="email">
                    <?php print Text::_('JSHOP_EMAIL') ?>   <?php if ($config_fields['email']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="email" id="email" value="<?php print $this->user->email ?>"
                    class="input form-control validate-email <?php if ($config_fields['email']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['birthday']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="birthday">
                    <?php print Text::_('JSHOP_BIRTHDAY') ?>   <?php if ($config_fields['birthday']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
            ...
            <?php if ($config_fields['home']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="home">
                    <?php print Text::_('JSHOP_HOME') ?>   <?php if ($config_fields['home']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
            ...
            <?php if ($config_fields['apartment']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="apartment">
                    <?php print Text::_('JSHOP_APARTMENT') ?>   <?php if ($config_fields['apartment']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="apartment" id="apartment" value="<?php print $this->user->apartment ?>"
                    class="input form-control <?php if ($config_fields['apartment']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['street']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="street">
                    <?php print Text::_('JSHOP_STREET_NR') ?>   <?php if ($config_fields['street']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="street" id="street" value="<?php print $this->user->street ?>"
                    class="input form-control <?php if ($config_fields['street']['require']): ?>required<?php endif ?>">
                  <?php if ($config_fields['street_nr']['display']) { ?>
                    <input type="text" name="street_nr" id="street_nr" value="<?php print $this->user->street_nr ?>"
                      class="input form-control <?php if ($config_fields['street_nr']['require']): ?>required<?php endif ?>">
                  <?php } ?>
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['zip']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="zip">
                    <?php print Text::_('JSHOP_ZIP') ?>   <?php if ($config_fields['zip']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
            ...
            <?php if ($config_fields['city']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="city">
                    <?php print Text::_('JSHOP_CITY') ?>   <?php if ($config_fields['city']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
            ...
            <?php if ($config_fields['state']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="state">
                    <?php print Text::_('JSHOP_STATE') ?>   <?php if ($config_fields['state']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
            ...
            <?php if ($config_fields['country']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="country">
                    <?php print Text::_('JSHOP_COUNTRY') ?>   <?php if ($config_fields['country']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
            ...
            <?php if ($config_fields['phone']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="phone">
                    <?php print Text::_('JSHOP_TELEFON') ?>   <?php if ($config_fields['phone']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="mobil_phone">
                    <?php print Text::_('JSHOP_MOBIL_PHONE') ?>   <?php if ($config_fields['mobil_phone']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="mobil_phone" id="mobil_phone" value="<?php print $this->user->mobil_phone ?>"
                    class="input form-control <?php if ($config_fields['mobil_phone']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['fax']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="fax">
                    <?php print Text::_('JSHOP_FAX') ?>   <?php if ($config_fields['fax']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="ext_field_1">
                    <?php print Text::_('JSHOP_EXT_FIELD_1') ?>   <?php if ($config_fields['ext_field_1']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="ext_field_1" id="ext_field_1" value="<?php print $this->user->ext_field_1 ?>"
                    class="input form-control <?php if ($config_fields['ext_field_1']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="ext_field_2">
                    <?php print Text::_('JSHOP_EXT_FIELD_2') ?>   <?php if ($config_fields['ext_field_2']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="ext_field_2" id="ext_field_2" value="<?php print $this->user->ext_field_2 ?>"
                    class="input form-control <?php if ($config_fields['ext_field_2']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="ext_field_3">
                    <?php print Text::_('JSHOP_EXT_FIELD_3') ?>   <?php if ($config_fields['ext_field_3']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="ext_field_3" id="ext_field_3" value="<?php print $this->user->ext_field_3 ?>"
                    class="input form-control <?php if ($config_fields['ext_field_3']['require']): ?>required<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['password']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="password">
                    <?php print Text::_('JSHOP_PASSWORD') ?>   <?php if ($config_fields['password']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="password_2">
                    <?php print Text::_('JSHOP_PASSWORD_2') ?>   <?php if ($config_fields['password_2']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
          ...
          <div id="div_delivery" class="jshop_register" style="<?php if (!$this->delivery_adress) { ?>display:none;<?php } ?>">
            ...
            <?php if ($config_fields['d_title']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_title">
                    <?php print Text::_('JSHOP_REG_TITLE') ?>   <?php if ($config_fields['d_title']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
            ...
            <?php if ($config_fields['d_f_name']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_f_name">
                    <?php print Text::_('JSHOP_F_NAME') ?>   <?php if ($config_fields['d_f_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_f_name" id="d_f_name" value="<?php print $this->user->d_f_name ?>"
                    class="input form-control <?php if ($config_fields['d_f_name']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_l_name']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_l_name">
                    <?php print Text::_('JSHOP_L_NAME') ?>   <?php if ($config_fields['d_l_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_l_name" id="d_l_name" value="<?php print $this->user->d_l_name ?>"
                    class="input form-control <?php if ($config_fields['d_l_name']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_m_name']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_m_name">
                    <?php print Text::_('JSHOP_M_NAME') ?>   <?php if ($config_fields['d_m_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_m_name" id="d_m_name" value="<?php print $this->user->d_m_name ?>"
                    class="input form-control <?php if ($config_fields['d_m_name']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_firma_name">
                    <?php print Text::_('JSHOP_FIRMA_NAME') ?>   <?php if ($config_fields['d_firma_name']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_firma_name" id="d_firma_name" value="<?php print $this->user->d_firma_name ?>"
                    class="input form-control <?php if ($config_fields['d_firma_name']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_email']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_email">
                    <?php print Text::_('JSHOP_EMAIL') ?>   <?php if ($config_fields['d_email']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_email" id="d_email" value="<?php print $this->user->d_email ?>"
                    class="input form-control validate-email <?php if ($config_fields['d_email']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_birthday">
                    <?php print Text::_('JSHOP_BIRTHDAY') ?>   <?php if ($config_fields['d_birthday']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
            ...
            <?php if ($config_fields['d_home']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_home">
                    <?php print Text::_('JSHOP_HOME') ?>   <?php if ($config_fields['d_home']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_home" id="d_home" value="<?php print $this->user->d_home ?>"
                    class="input form-control <?php if ($config_fields['d_home']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_apartment">
                    <?php print Text::_('JSHOP_APARTMENT') ?>   <?php if ($config_fields['d_apartment']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_apartment" id="d_apartment" value="<?php print $this->user->d_apartment ?>"
                    class="input form-control <?php if ($config_fields['d_apartment']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_street']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_street">
                    <?php print Text::_('JSHOP_STREET_NR') ?>   <?php if ($config_fields['d_street']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_street" id="d_street" value="<?php print $this->user->d_street ?>"
                    class="input form-control <?php if ($config_fields['d_street']['require']): ?>required-d<?php endif ?>">
                  <?php if ($config_fields['d_street_nr']['display']) { ?>
                    <input type="text" name="d_street_nr" id="d_street_nr" value="<?php print $this->user->d_street_nr ?>"
                      class="input form-control <?php if ($config_fields['d_street_nr']['require']): ?>required-d<?php endif ?>">
                  <?php } ?>
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_zip']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_zip">
                    <?php print Text::_('JSHOP_ZIP') ?>   <?php if ($config_fields['d_zip']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_zip" id="d_zip" value="<?php print $this->user->d_zip ?>"
                    class="input form-control <?php if ($config_fields['d_zip']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_city']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_city">
                    <?php print Text::_('JSHOP_CITY') ?>   <?php if ($config_fields['d_city']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_city" id="d_city" value="<?php print $this->user->d_city ?>"
                    class="input form-control <?php if ($config_fields['d_city']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_state']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_state">
                    <?php print Text::_('JSHOP_STATE') ?>   <?php if ($config_fields['d_state']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_state" id="d_state" value="<?php print $this->user->d_state ?>"
                    class="input form-control <?php if ($config_fields['d_state']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_country']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_country">
                    <?php print Text::_('JSHOP_COUNTRY') ?>   <?php if ($config_fields['d_country']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <?php
            ...
            <?php if ($config_fields['d_phone']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_phone">
                    <?php print Text::_('JSHOP_TELEFON') ?>   <?php if ($config_fields['d_phone']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_phone" id="d_phone" value="<?php print $this->user->d_phone ?>"
                    class="input form-control <?php if ($config_fields['d_phone']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_mobil_phone">
                    <?php print Text::_('JSHOP_MOBIL_PHONE') ?>   <?php if ($config_fields['d_mobil_phone']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_mobil_phone" id="d_mobil_phone" value="<?php print $this->user->d_mobil_phone ?>"
                    class="input form-control <?php if ($config_fields['d_mobil_phone']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
            ...
            <?php if ($config_fields['d_fax']['display']): ?>
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_fax">
                    <?php print Text::_('JSHOP_FAX') ?>   <?php if ($config_fields['d_fax']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_fax" id="d_fax" value="<?php print $this->user->d_fax ?>"
                    class="input form-control <?php if ($config_fields['d_fax']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_ext_field_1">
                    <?php print Text::_('JSHOP_EXT_FIELD_1') ?>   <?php if ($config_fields['d_ext_field_1']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_ext_field_1" id="d_ext_field_1" value="<?php print $this->user->d_ext_field_1 ?>"
                    class="input form-control <?php if ($config_fields['d_ext_field_1']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_ext_field_2">
                    <?php print Text::_('JSHOP_EXT_FIELD_2') ?>   <?php if ($config_fields['d_ext_field_2']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_ext_field_2" id="d_ext_field_2" value="<?php print $this->user->d_ext_field_2 ?>"
                    class="input form-control <?php if ($config_fields['d_ext_field_2']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
              ...
              <div class="control-group">
                <div class="control-label name">
                  <label for="d_ext_field_3">
                    <?php print Text::_('JSHOP_EXT_FIELD_3') ?>   <?php if ($config_fields['d_ext_field_3']['require']): ?><span>*</span><?php endif; ?>
                  </label>
                </div>
                <div class="controls">
                  <input type="text" name="d_ext_field_3" id="d_ext_field_3" value="<?php print $this->user->d_ext_field_3 ?>"
                    class="input form-control <?php if ($config_fields['d_ext_field_3']['require']): ?>required-d<?php endif ?>">
                </div>
              </div>
            <?php endif; ?>
                ...
                <div class="control-label name">
                  <label for="privacy_statement">
                    <a class="privacy_statement" href="#"
                      ...
                      <?php print Text::_('JSHOP_PRIVACY_STATEMENT') ?>   <?php if ($config_fields['privacy_statement']['require']): ?><span>*</span><?php endif; ?>
                    </a>
                  </label>
                </div>
                <div class="controls">
          ...
          <div class="control-group box_button">
            <div class="controls">
              ...
              <input type="submit" name="next" value="<?php print Text::_('JSHOP_SAVE') ?>" class="btn btn-primary button" />
            </div>
          </div>
        </form>
      </div>
