                        ...
                        <div class="control-group box_price_from_to d-flex">
                            ...
                            <div class="controls form-inline d-flex">
                                <span class="input-append">
                                    <input type="text" class="input form-control" name="fprice_from" id="price_from" size="7" placeholder="<?php print \JText::_('JSHOP_FROM') ?>" value="<?php if ($this->filters['price_from'] > 0)
                                           print $this->filters['price_from'] ?>" />
                                    </span>
                                    <span class="price_ftspace mt-2">-</span>
                                    <span class="input-append">
                                        <input type="text" class="input form-control" name="fprice_to" id="price_to" size="7" placeholder="<?php print \JText::_('JSHOP_TO') ?>" value="<?php if ($this->filters['price_to'] > 0)
