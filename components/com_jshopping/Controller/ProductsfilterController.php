...
class ProductsfilterController extends BaseController{
	...
	function display($cachable = false, $urlparams = false){
        ...
        if ($params->get('position_description', 0) == 0) {
            $view->_tmp_list_products_html_start = $params->get('description', '');            
        } else {
            $view->_tmp_list_products_html_end = $params->get('description', '');;
        }
