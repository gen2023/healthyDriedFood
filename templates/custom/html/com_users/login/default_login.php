...
?>
<div class="login-page com-users-reset com-users-login login">
    <div class="wrapper">
    <?php if ($this->params->get('show_page_heading')) : ?>
    <div class="page-header">
        <h1 class="ttl sm centered mb30">
    ...
    <form action="<?php echo Route::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="com-users-login__form form-validate form-horizontal well" id="com-users-login__form">
        ...
        <div>
            ...
            <div class="com-users-login__submit control-group mb30">
                <div class="controls">
    ...
    <?php /* <div class="com-users-login__options list-group">
