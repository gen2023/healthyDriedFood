...
<div class="jshop jshop_list_product" style="position:relative;">
    <div class="swiper <?= $params['swiperclass_sfx'] ?>" style="position:relative;">
                        ...
                        <div class="oiproduct">
                            ...
                            <div class="buttons">
                                <?php if ($data['jshopConfig']->enable_wishlist) { ?>
                                    <a class="btn button btn-wishlist btn-secondary"
                                        href="<?= $product->buy_link ?>&to=wishlist">
