 ...
 * @package     com_exportxml
 */
class PromsyncController extends BaseController
{
    /**
     ...
     * @var string
     */
    protected $default_view = 'promsync';
    protected $export_type = 'prom';
    ...
    public function display($cachable = false, $urlparams = array())
    {
        ...
        foreach ($paramsProduct as &$param) {
            ...
            $param['value_name'] = $extraFieldsMap[$valueId] ?? 'Неизвестное значение';
        }
