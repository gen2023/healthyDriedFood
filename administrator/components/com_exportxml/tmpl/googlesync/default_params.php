...
<div class="row">
  <div class="col-6">
    <div id="params_table" class="card">
      ...
      <table class="table table-striped table-hover">
        <thead>
          <tr>
            <th class="text-left"><?= Text::_('COM_EXPORT_TABLE_COL_PARAMS_GOOGLE') ?></th>
          ...
          <?php if (!empty($this->results_params)): ?>
            ...
            <?php foreach ($this->results_params as $params): ?>
              <tr class="table-row" data-id="<?= (int) $params['id'] ?>">
                ...
                <td classs="text-left"><?= htmlspecialchars($params['google_param'], ENT_QUOTES, 'UTF-8') ?></td>
  ...
  <div class="col-6">
    <div id="extra_fields_block" class="card">
      ...
      <div class="row">
        <div class="col-6">
          <div class="form-group">
            ...
            <select id="google_param" name="google_param[]" class="inputbox form-select">
              <option value="00">---</option>
              <?php foreach ($this->google_params as $param): ?>
                <option value="<?php echo htmlspecialchars($param['id']); ?>">
                  <?php echo htmlspecialchars($param['google_param']); ?>
                </option>
              <?php endforeach; ?>
            </select>
          </div>
        ...
        <div class="col-6">
          <div class="form-group">
            <label for=""><?= Text::_('COM_EXPORT_TABLE_COL_VALUE') ?></label>
      ...
      <button type="button" id="button-googleparams-add" class="btn btn-primary">
