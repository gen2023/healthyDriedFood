...
namespace Joomla\Component\NevigenAudit\Administrator\View\Products;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->link          = $this->getLink('index.php?option=com_nevigen_audit&view=products');
		...
		$this->triggerViewAddTabsEvent($this->tabs, 'com_nevigen_audit.products');
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_NEVIGEN_AUDIT')
			. ': ' . Text::_('COM_NEVIGEN_AUDIT_PRODUCTS_AUDIT'), 'cart');

		$toolbar = Toolbar::getInstance();
		$user    = $this->getCurrentUser();

		$toolbar->addNew('products.add');
	...
	{
		return [
			'p.product_id'         => Text::_('JGRID_HEADING_ID'),
			'p.name'               => Text::_('JSHOP_TITLE'),
			'p.product_quantity'   => Text::_('JSHOP_QUANTITY'),
			'p.product_price'      => Text::_('JSHOP_PRICE'),
			'p.product_date_added' => Text::_('JSHOP_DATE'),
		];
	}
}