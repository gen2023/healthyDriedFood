      ...
      <div class="card p-2 mb-3">
        ...
        <div class="mass_operation mass_operation-js mt-3 mb-3">
          <select id="mass_operation_type" name="mass_operation_type" class="form-select">
            <option value="product_price"><?php echo Text::_('JSHOP_PRICE'); ?></option>
            <option value="product_old_price"><?php echo Text::_('JSHOP_OLD_PRICE'); ?></option>
            <option value="product_quantity"><?php echo Text::_('JSHOP_QUANTITY'); ?></option>
            <option value="hits"><?php echo Text::_('JSHOP_HITS'); ?></option>
            <option value="product_manufacturer_id"><?php echo Text::_('JSHOP_MANUFACTURER'); ?></option>
            <option value="currency_id"><?php echo Text::_('JSHOP_CURRENCY_PARAMETERS'); ?></option>
            <option value="label_id"><?php echo Text::_('JSHOP_LIST_PRODUCT_LABELS'); ?></option>
          </select>
    ...
    <table class="table table-striped product_list product_list-js">
      <thead>
        <tr>
          ...
          <?php if ($params_plg['show_nameProduct']) { ?>
            <th>
          ...
          <?php } ?>
          <?php if ($this->show_vendor && $params_plg['show_labelProduct']) { ?>
            <th width="80">
          ...
          <tr class="row<?php echo $i % 2; ?>" data-draggable-group="1" item-id="<?php echo $row->product_id; ?>" parents="" level="1">
            ...
            <?php if ($params_plg['show_additionPriceProduct']) { ?>
              <td data-field="product_addition_price" data-type="modal" data-product_id="<?= (int) $row->product_id; ?>">
                <div onclick="openModalAdditionPrice(<?= $row->product_id ?>)">
